...
namespace My.RolePermission.DALSessionFactory
{
	public partial class DBSession : IDBSession
    {
		...
		private ISMEXCEPTIONTBRepository _SMEXCEPTIONTBRepository;
        public ISMEXCEPTIONTBRepository ISMEXCEPTIONTBRepository
        {
            get
            {
                if(_SMEXCEPTIONTBRepository == null)
                {
                   // _SMEXCEPTIONTBRepository = new SMEXCEPTIONTBRepository();
				    _SMEXCEPTIONTBRepository =DalFactory.GetSMEXCEPTIONTBRepository;
                }
                return _SMEXCEPTIONTBRepository;
            }
            set { _SMEXCEPTIONTBRepository = value; }
        }
